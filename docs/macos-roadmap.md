...
| UI multiplataforma | Em andamento | `Chordious.Desktop` em `net10.0` executa biblioteca, marcas e rótulos de casa em Avalonia; 16 testes Desktop aprovados |
...
| Diagram Editor | Dimensões, título, marcas, pestanas, rótulos, estilos, preview e clipboard | PARCIAL — criar/editar, título, cordas, casas, preview, marcas e rótulos reais; seleção no diagrama oferece adicionar/editar/remover e fechamento protege alterações não salvas |
...
| Element editors | Mark, Barre, Fret Label e Style | PARCIAL — Mark Editor e Fret Label Editor cobrem todas as propriedades existentes, estilos locais, aplicar/salvar/cancelar e proteção contra perda; Barre e Style permanecem pendentes |
