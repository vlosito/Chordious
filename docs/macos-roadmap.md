...
| UI multiplataforma | Em andamento | `Chordious.Desktop` em `net10.0` executa biblioteca e editor básico em Avalonia |
...
| Diagram Editor | Dimensões, título, marcas, pestanas, rótulos, estilos, preview e clipboard | PARCIAL — criar/editar, título, cordas, casas, preview e marcas reais; seleção no diagrama oferece adicionar/editar/remover e fechamento protege alterações não salvas |
...
| Element editors | Mark, Barre, Fret Label e Style | PARCIAL — Mark Editor cobre conteúdo, tipo, forma, fundo, borda, tipografia, estilos locais, aplicar/salvar/cancelar e proteção contra perda; demais editores pendentes |
...
- As issues `#8` a `#13` formaram o conjunto inicial de bloqueadores conhecidos
  da versão estável para macOS; as `#11` e `#13` estão resolvidas na PR draft
  `#1` e serão fechadas automaticamente após o merge.
