    ...
    private async void Window_PointerMoved(object? sender, PointerEventArgs e)
    {
        ...
        try
        {
            DataTransfer dragData =
                await DiagramDragDropService.CreateDiagramDataAsync(
                    image,
                    viewModel.ObservableDiagram);
